...
<body class="gray-bg">
                    ...
                    <div class="ibox-content">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="username" value="<?php echo ($user["username"]); ?>" placeholder="请填写用户名" id="username">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php if(($user['images_id'] != '')): ?><img src="<?php echo getImage($user['images_id']);?>" class="images" style="width:100px;margin-bottom: 2px;"/><?php endif; ?>
                                    <!--dom结构部分-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" class="form-control" name="password" placeholder="请填写密码(选填)" id="password">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" class="form-control" name="confirm" placeholder="请填写确认密码(选填)" id="confirm">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="radio i-checks">
                                        <label><input type="radio" value="0" name="status" <?php if(($user['status'] == 0)): ?>checked="checked"<?php endif; ?> > <i></i>启用</label>
                                        <label><input type="radio" value="1" name="status" <?php if(($user['status'] == 1)): ?>checked="checked"<?php endif; ?> > <i></i>禁用</label>
                                    </div>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control m-b" name="role_id" id="role_id">
                                        <?php if(is_array($role)): $i = 0; $__LIST__ = $role;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$role): $mod = ($i % 2 );++$i;?><option value="<?php echo ($role["id"]); ?>" <?php if(($role['id'] == $user['role_id'])): ?>selected="selected"<?php endif; ?> ><?php echo ($role["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
    ...
    <script>
        //定义全局变量
        var GV = {
            user_edituser : "<?php echo U('User/editUser');?>",
            user_is_username : "<?php echo U('User/is_username');?>",
            user_getusername : "<?php echo U('User/getUsername');?>"
        };
    </script>
    <script src="/union/public/Admin/js/http/user/edituser.js"></script>
