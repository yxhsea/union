                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control m-b" name="role_id" id="role_id">
                                    <?php if(is_array($role)): $i = 0; $__LIST__ = $role;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$role): $mod = ($i % 2 );++$i;?><option value="<?php echo ($role["id"]); ?>"><?php echo ($role["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
...
<script>
    //定义全局变量
    var GV = {
        user_adduser : "<?php echo U('User/addUser');?>",
        user_is_username : "<?php echo U('User/is_username');?>"
    };
</script>
<script src="/union/public/Admin/js/http/user/adduser.js"></script>
