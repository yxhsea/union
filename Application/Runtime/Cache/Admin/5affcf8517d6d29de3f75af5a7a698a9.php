                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div id="uploader" class="wu-example">
                                    ...
                                    <div class="btns">
                                        <div id="picker" style="position: absolute;">选择文件</div>
                                        <button id="ctlBtn" class="btn btn-default" style="position: relative;margin-left: 100px;margin-top: 3px;">开始上传</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script src="/union/public/Admin/js/http/doc/adddoc.js"></script>
