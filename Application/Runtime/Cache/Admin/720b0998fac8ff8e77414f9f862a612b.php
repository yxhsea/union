            ...
            <div class="ibox">
                <div class="ibox-content">
                    <div class="pull-right">
                        <span class="badge badge-success">Author <?php echo ($detailnews["author"]); ?></span>
                        <span class="badge badge-primary">Time <?php echo (date("Y-m-d H:i:s",$detailnews["create_time"])); ?></span>
                        <button type="button" class="btn btn-outline btn-primary btn-xs" onclick="history.go(-1);">返回</button>
                    </div>
                    <div class="text-center article-title">
                        <h1>
                           <?php echo ($detailnews["title"]); ?>
                        </h1>
                    </div>
