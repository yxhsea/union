                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control m-b" name="pid" id="pid">
                                        ...
                                        <?php if(is_array($catelist)): $i = 0; $__LIST__ = $catelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$catelist): $mod = ($i % 2 );++$i;?><option value="<?php echo ($catelist["id"]); ?>" <?php if(($catelist['id'] == $cate['pid'])): ?>selected="selected"<?php endif; ?> ><?php echo ($catelist["level"]); echo ($catelist["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="title" placeholder="请填写分类名称" id="title" value="<?php echo ($cate["title"]); ?>">
                                </div>
                            </div>
...
<script>
    //定义全局变量
    var GV = {
        news_editcate : "<?php echo U('News/editcate');?>",
        cate_id : "<?php echo ($cate["id"]); ?>"
    };
</script>
<script src="/union/public/Admin/js/http/news/editcate.js"></script>
