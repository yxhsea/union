                ...
                <div class="ibox-content">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="title" placeholder="请填写分类名称" id="title">
                            </div>
                        </div>
...
<script>
    //定义全局变量
    var GV = {
        news_addcate : "<?php echo U('news/addcate');?>"
    };
</script>
<script src="/union/public/Admin/js/http/news/addcate.js"></script>
