                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <?php if(is_array($auth)): $i = 0; $__LIST__ = $auth;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$auth): $mod = ($i % 2 );++$i;?><div class="checkbox i-checks">
                                        <label>
                                            <?php echo ($auth["level"]); ?><input type="checkbox" name="auth" value="<?php echo ($auth["id"]); ?>"> <i></i><?php echo ($auth["name"]); ?>
                                        </label>
...
<script src="/union/public/Admin/js/http/role/addrole.js"></script>
