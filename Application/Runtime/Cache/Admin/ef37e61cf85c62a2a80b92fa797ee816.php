...
<body class="gray-bg">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control m-b" name="pid" id="pid">
                                        ...
                                        <?php if(is_array($auth)): $i = 0; $__LIST__ = $auth;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$auth): $mod = ($i % 2 );++$i;?><option value="<?php echo ($auth["id"]); ?>"><?php echo ($auth["level"]); echo ($auth["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                            </div>
    ...
    <script src="/union/public/Admin/js/http/auth/addauth.js"></script>
