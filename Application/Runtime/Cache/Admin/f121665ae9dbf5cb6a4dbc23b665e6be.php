                ...
                <div class="ibox-content">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <img src="<?php echo getImage($member['picture']);?>" class="images" style="width:100px;margin-bottom: 2px;"/>
                                <!--dom结构部分-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="radio i-checks">
                                    <label><input type="radio" value="0" name="sex" <?php if(($member['sex'] == 0)): ?>checked="checked"<?php endif; ?> > <i></i> 男</label>
                                    <label><input type="radio" value="1" name="sex" <?php if(($member['sex'] == 1)): ?>checked="checked"<?php endif; ?> > <i></i>女</label>
                                </div>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="national" value="<?php echo ($member["national"]); ?>" placeholder="请填写民族" id="national">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="native_place" value="<?php echo ($member["native_place"]); ?>" placeholder="请填写籍贯" id="native_place">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="birthday" value="<?php echo ($member["birthday"]); ?>"  placeholder="请填写出生日期" id="birthday"  onclick="laydate();">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="political" value="<?php echo ($member["political"]); ?>" placeholder="请填写政治面貌" id="political">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="professional" value="<?php echo ($member["professional"]); ?>" placeholder="请填写专业" id="professional">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="college" value="<?php echo ($member["college"]); ?>" placeholder="请填写毕业院校" id="college">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="zip_code" value="<?php echo ($member["zip_code"]); ?>" placeholder="请填写邮编" id="zip_code">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="id_card" value="<?php echo ($member["id_card"]); ?>" placeholder="请填写身份证号码" id="id_card">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control layer-date" name="card_start" value="<?php echo ($member["card_start"]); ?>" placeholder="身份证开始时间" id="start">
                                <input type="text" class="form-control layer-date" name="card_end" value="<?php echo ($member["card_end"]); ?>" placeholder="身份证到期时间" id="end">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="unit_code" value="<?php echo ($member["unit_code"]); ?>" placeholder="请填写单位编码" id="unit_code">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="unit" value="<?php echo ($member["unit"]); ?>" placeholder="请填写所属单位" id="unit">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="radio i-checks">
                                    <label><input type="radio" value="0" name="school" <?php if(($member['school'] == 0)): ?>checked="checked"<?php endif; ?> > <i></i> 小学</label>
                                    <label><input type="radio" value="1" name="school" <?php if(($member['school'] == 1)): ?>checked="checked"<?php endif; ?> > <i></i> 初中</label>
                                    <label><input type="radio" value="2" name="school" <?php if(($member['school'] == 2)): ?>checked="checked"<?php endif; ?> > <i></i> 高中</label>
                                    <label><input type="radio" value="3" name="school" <?php if(($member['school'] == 3)): ?>checked="checked"<?php endif; ?> > <i></i> 中专</label>
                                    <label><input type="radio" value="4" name="school" <?php if(($member['school'] == 4)): ?>checked="checked"<?php endif; ?> > <i></i> 大专</label>
                                    <label><input type="radio" value="5" name="school" <?php if(($member['school'] == 5)): ?>checked="checked"<?php endif; ?> > <i></i> 本科</label>
                                    <label><input type="radio" value="6" name="school" <?php if(($member['school'] == 6)): ?>checked="checked"<?php endif; ?> > <i></i> 研究生</label>
                                    <label><input type="radio" value="7" name="school" <?php if(($member['school'] == 7)): ?>checked="checked"<?php endif; ?> > <i></i> 博士</label>
                                </div>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="radio i-checks">
                                    <label><input type="radio" value="1" name="migrant" <?php if(($member['migrant'] == 1)): ?>checked="checked"<?php endif; ?> > <i></i> 是</label>
                                    <label><input type="radio" value="0" name="migrant" <?php if(($member['migrant'] == 0)): ?>checked="checked"<?php endif; ?> > <i></i>否</label>
                                </div>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="phone" value="<?php echo ($member["phone"]); ?>" placeholder="请填写联系电话" id="phone">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control layer-date" name="come_time" value="<?php echo ($member["come_time"]); ?>" placeholder="请填写入会时间" id="come_time"  onclick="laydate();">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="address_now" value="<?php echo ($member["address_now"]); ?>" placeholder="请填写居住地" id="address_now">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
...
<script src="/union/public/Admin/js/http/member/editmember.js"></script>
