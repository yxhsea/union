...
$(document).ready(function(){
    ...
    $("#save").click(function(){
        var sports_id = $.trim($("input[name='sports_id']").val());
        ...
        var introduct = $.trim($("input[name='introduct']").val());
        ...
        $.ajax({
            'url': GV.sports_editsporst,
            'type':'post',
            'data':{'sports_id':sports_id,'theme':theme,'host':host,'undertake':undertake,'start_time':start_time,'end_time':end_time,'address':address,'header':header,'phone':phone,'introduct':introduct},
