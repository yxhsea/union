...
$(document).ready(function(){
   $("#a_save").click(function(){
       ...
       $.ajax({
           'url': GV.reward_addreward,
           'type':'post',
           'data':{'type':a_type,'member_id_card':a_member_id_card,'member_name':a_member_name,'reward_time':a_reward_time,'reward_title':a_reward_title,'reward_level':a_reward_level,'reward_unit':a_reward_unit,'reward_unit':a_reward_unit,'reward_reason':a_reward_reason,'reward_note':a_reward_note},
   ...
   $("#b_save").click(function(){
        ...
        $.ajax({
            'url': GV.reward_addreward,
            'type':'post',
            'data':{'type':b_type,'member_id_card':b_member_id_card,'member_name':b_member_name,'reward_time':b_reward_time,'reward_title':b_reward_title,'reward_level':b_reward_level,'reward_unit':b_reward_unit,'reward_unit':b_reward_unit,'reward_reason':b_reward_reason,'reward_note':b_reward_note},
            success:function(data){
                //console.log(data);
                if(data.status == 1){
                    layer.msg(data.info);
