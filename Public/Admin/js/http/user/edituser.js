$(document).ready(function(){
    ...
    $("#save").click(function(){
        ...
        console.log(getUsername(user_id));
        if(getUsername(user_id) != username){
            //验证用户名是否已经存在
        ...
        $.ajax({
            'url': GV.user_adduser,
            'type':'post',
            'data':{'id':user_id,'username':username,'password':password,'status':status,'role_id':role_id,'images_id':images_id},
